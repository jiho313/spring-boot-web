   ...
   <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
         ...
         <sec:authorize access="isAuthenticated()">
         	...
         	<span class="navber-text text-white"><strong class="text-white">${employee.firstName } ${employee.lastName }</strong>님 환영합니다.</span>
         </sec:authorize>
         ...
         <ul class="navbar-nav">
            ...
            <li class="nav-item">
               <a class="nav-link ${menu eq '회원가입' ? 'active' : '' }" href="/emp/add">회원가입</a>
            </li>
            </sec:authorize>
         </ul>
      </div>
